@extends('layouts.publicarLayout')
    ...
    @section('css')
    <link rel="stylesheet" href="{{ URL::asset('css/organizacoes.css') }}">
    @endsection
    @section('content')
                ...
                <div class="titulo-bottom">
                    <div class="titulo-bottom-conteudo">
                        <div class="titulo-links">
                            <a href="#" class="pagina-atual">Todas os pedidos</a>
                        </div>
                    </div>
                ...
                <div class="btn-publicacao">
                    <a class="conteudo-btn-post" href="/adm/analisar/{{$organizacao->id}}">
                        ...
                        <div class="organizacao-post">
                            <div class="titulo-btn-publicacao">Criador</div>
                            <p>{{$organizacao->nome_lider}}</p>
                        </div>
                    </a>
