            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li id="divider2"><hr class="dropdown-divider"></li>
              ...
              <form class="d-flex" role="search">
                ...
                <div class="dropstart">
                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownCenterBtn" data-bs-toggle="dropdown" aria-expanded="false">
                          <div class="imagem-perfil-navbar"><img src="{{asset('images/users/' . $id->foto)}}" alt="foto de perfil"></div>
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownCenterBtn" id="dropdown-perfil">
                          
                          <li><a class="dropdown-item" href="#">
                            <svg width="19" height="15" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0 2V13.9663C0 15.6415 1.93638 16.5744 3.24649 15.5303L6.02574 13.3153C6.78263 12.7121 7.86286 12.7375 8.59065 13.3755L10.6816 15.2085C11.9743 16.3418 14 15.4238 14 13.7046V2C14 0.895431 13.1046 0 12 0H2C0.895431 0 0 0.895427 0 2Z" fill="#253042"/>
                              </svg>
                              Coleções</a></li>
                          ...
                          <li><hr class="dropdown-divider"></li>
                          <li><a class="dropdown-item" href="{{ action('LoginController@deslogar') }}"><i class="fa-solid fa-right-to-bracket"></i> Sair</a></li>
                      </ul>
                  </div>
                @else
               ...
               <a href="{{route('login.index') }}"> <button type="button" class="btn btn-fazer-login" > Fazer login</button> </a>
               </div>
                @endif
            </div>
        </div>
